    ...
    >
      ...
      <main className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
        ...
        <header className="mb-8 md:mb-16">
          <h1 className="font-headline text-3xl md:text-7xl font-extrabold tracking-tighter text-on-surface dark:text-stone-100 mb-2">
            Welcome back, {user?.name?.split(' ')[0] || 'User'}
          </h1>
          <p className="text-on-surface-variant dark:text-stone-400 text-sm md:text-lg max-w-2xl">
